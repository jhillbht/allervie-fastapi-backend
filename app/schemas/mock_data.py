"""
Mock data for Google Ads API responses.
"""
...
# Mock data for dashboard performance metrics
mockAdsPerformance = AdsPerformanceData(
    impressions=MetricWithChange(value=203626, change=41.9),
    clicks=MetricWithChange(value=4581, change=26.8),
    conversions=MetricWithChange(value=104, change=26.5),
    cost=MetricWithChange(value=4488, change=41.9),
    clickThroughRate=MetricWithChange(value=2.25, change=-16.1),
    conversionRate=MetricWithChange(value=2.28, change=20.1),
    costPerConversion=MetricWithChange(value=43.16, change=33.0)
)
